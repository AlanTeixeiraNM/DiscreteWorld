...
export module counting;

//In order to import the std as a module you need the std.ifc binary file
//You can either compile it or refer to it on the compilation command line if you already have it somewhere
import std;
...
concept input_set = std::ranges::input_range<InR> &&
...
//partial factorial. 0 <= K <= N.
//K indicates when to stop multiplying. It represents N!/K!
export template<std::integral T>
...
//combinations class lazily generates a sequence of all combinations of a input_set taken K to K
...
//the sequence restarts when comb_it pass end()
