...
planet_generator::Planet::Planet(std::string_view gov, const std::string& econ, unsigned short tech_lvl, 
    unsigned short popu, unsigned short prod, std::string_view speci, unsigned short avr, std::string_view nm)
